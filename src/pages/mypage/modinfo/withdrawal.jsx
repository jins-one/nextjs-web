...
export default function modifyWPW({session, ...props}) {
    ...
    function checkNumber() {
        ...
        if (w_pw == mydata.w_password) {
            setSeq(1);
            setForm((p) => { return { ...p, value1: '', value2: '', value3: '', value4: '', value5: '', value6: '', value7: '', value8: '' } });
            setF(false);
        } else {
    ...
    return (
        <>
            ...
            {
                seq2 == 0 ? (
                    <PhoneAuth setSeq={setSeq2} title={'출금 비밀번호 변경'} phone={props.phone} setCode={setCode}/>
                ) : (
                    <>
                        ...
                        <Container>
                            <section className={styles.section} style={{ minHeight: 'calc(100vh - 70px - 314px)' }}>
                                <div className={styles.pwModifyContainer}>
                                    ...
                                    <div className={styles.title}>출금 비밀번호 변경</div>
                                    <div className={styles.subTitle}>
                                        {seq == 0 ? <>기존 비밀번호를 입력하여 주세요.</> : <>새로운 출금 비밀번호를 입력하여 주세요.</>}
                                    </div>

                                    <div className={styles.modiInputDiv2}>
                                        <div className={styles.inputLabel}>
                                            {seq == 0 ? <>기존 비밀번호</> : <>새 출금 비밀번호</>}
                                            {(f && seq == 0 && !isValid.pw) && <ValidText valueType={'pw'} />}
                                            {(f && seq == 1 && !isValid.new_pw2) ? <ValidText valueType={'wpw2'} /> : (f && seq == 1 && !isValid.new_pw) && <ValidText valueType={'wpw'} />}
                                        </div>
...

                                    {
                                        seq == 1 && (
                                            <div className={styles.modiInputDiv2}>
                                                <div className={styles.inputLabel}>
                                                    비밀번호 확인 {(f && seq == 1 && !isValid.again_pw) && <ValidText valueType={'pw'} />}
                                                </div>
                                                <div className={styles.secureInput}>
                                    ...
                                    <div className={styles.btnDiv}>
                                        ...
                                        {
                                            seq == 0 ? <div className={styles.authBtn} onClick={checkNumber} style={{ width: '27.5rem' }}>확인</div>
                                                :
