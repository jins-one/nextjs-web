...
export default function AssetsTransactionHistoryMobile({ onModal, closeModal, ...props }) {
    ...
    useEffect(() => {
        if (toggle) {
            ...
            document.querySelector('dialog.assetsTransactionHistory').classList.add('scrollLock');
        } else {
            optionRef.current.style.display = 'none';
            document.querySelector('dialog.assetsTransactionHistory').classList.remove('scrollLock');
        }
    }, [toggle])
    ...
    return (
        <>
            ...
            <dialog ref={modalRef} className={`assetsTransactionHistory ${styles.modal}`} onCancel={test}>
                    ...
                    <div className={styles.contentsBox}>
                                ...
                                <div style={{ paddingTop: '17px' }} className={styles.historyListDiv}>
                                    {
                                        historyList.map((h, index) => (
                                            <AssetsHistory_m modal={setWithdrawlWaitModal} close={toggleClose} data={h} key={index} />
                                        ))
                                    }
                                </div>
                            ) : (
                        ...
                        <div className={styles.infoBox}>
                            <div className={styles.infoBoxTitleBox}>
                                ...
                                <span className={styles.title}>입출금관련 안내사항</span>
                            </div>
                            ...
                            <div className={styles.options}>
                                ...
                                <div className={styles.optionItem}>
                                    ...
                                    <div className={`${styles.status} ${styles.optionContents}`}>
                                        <div className={styles.deposit}>
                                            <div>
                                                <input id='total' type={'radio'} name={'status'} onChange={radioChange1} value={'total'} checked={statusChoice == 'total'} />
                                                <label className={styles.statusChoice} htmlFor='total'>전체</label>
                                            </div>
                                            <div>
                                                <input id='ddone' type={'radio'} name={'status'} onChange={radioChange1} value={'d_done'} checked={statusChoice == 'd_done'} />
                                                <label className={styles.statusChoice} htmlFor='ddone'>입금완료</label>
                                            </div>
                                            <div>
                                                <input id='dfail' type={'radio'} name={'status'} onChange={radioChange1} value={'d_fail'} checked={statusChoice == 'd_fail'} />
                                                <label className={styles.statusChoice} htmlFor='dfail'>입금실패</label>
                                            </div>
                                        </div>
                                ...
                                <div className={styles.optionItem}>
                                    ...
                                    <div className={`${styles.sort} ${styles.optionContents}`}>
                                        <div>
                                            <input id='latest' type={'radio'} name={'sort'} onChange={radioChange2} value={'desc'} checked={sortChoice == 'desc'} />
                                            <label className={styles.statusChoice} htmlFor='latest'>최신순</label>
                                        </div>
                                        <div>
                                            <input id='past' type={'radio'} name={'sort'} onChange={radioChange2} value={'asc'} checked={sortChoice == 'asc'} />
                                            <label className={styles.statusChoice} htmlFor='past'>과거순</label>
                                        </div>
                                    </div>
                                </div>
